...
function main(){
    ...
    for(var i=0;i<len/2;i++){
        var x = obj.popCharacter();
        var y = obj.dequeueCharacter();
        console.log(`x=${x} y=${y}`);
        if(x!=y){
            isPalindrome=false;
          	break;
